...
(function($) {
    ...
    var methods = {
        ...
        initTree: function(options) {
            ...
            console.log("render initTree");
            var render = this.each(function() {
                console.log("render initTree");
                var $this = $(this);
            ...
            console.log(this);
            this.treegrid('getRootNodes').treegrid('render','init');
            return render;
        },
        /**
         * Initialize node
         ...
         * @returns {Node}
         */
        render: function(isOneOfParentsCollapsed) {
            var render = $(this).each(function() {
                var $this = $(this);
                console.log("render each timing....",isOneOfParentsCollapsed+"..isOneOfParentsCollapsed",$this)
                //if parent colapsed we hidden
                if(isOneOfParentsCollapsed == 'init'||isOneOfParentsCollapsed == null)
                    isOneOfParentsCollapsed = $this.treegrid('isOneOfParentsCollapsed')
                if (isOneOfParentsCollapsed) {
                    $this.hide();
                } else {
                    $this.show();
                }
                if (!$this.treegrid('isLeaf')) {
                    isOneOfParentsCollapsed = isOneOfParentsCollapsed || $this.treegrid('isCollapsed');
                    $this.treegrid('renderExpander');
                    $this.treegrid('getChildNodes').treegrid('render',isOneOfParentsCollapsed);
                }
            });
            return render;
        },
        ...
        renderExpander: function() {
            console.log("renderExpander timing");
            return $(this).each(function() {
                var $this = $(this);
                var expander = $this.treegrid('getSetting', 'getExpander').apply(this);
                if (expander) {
